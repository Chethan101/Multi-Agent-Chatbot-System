...
def get_replanner():
    ...
    """Your task is to revise the current plan based on the executed steps. Remove any steps that have been completed and ensure the remaining steps will lead to the complete answer for the objective. If no more steps are required, provide the final response.
